...
В данном репозитории находится программный код проекта для Arduino Uno R3, соединенного с датчиком цвета TCS34725 и жидкокристаллическим дисплеем LCD 1602. Этот проект является частью моей магистерской диссертации. Слово "Microepsidal" было придумано, с целью чтобы упростить название.

Разработал Игошин Ярослав Евгеньевич. Разработано в 2025 году.
